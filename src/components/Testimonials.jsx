        ...
        <div className="container">
            ...
            <Swiper
                ...
                {testimonialItems.map(item => (
                    /* card swiper slide */
                    <SwiperSlide className='bg-white p-6 rounded-xl mb-16' key={item.id}>
                        {/* card */}
                        <div>
                            ...
                            <p className="mt-2 mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius repellendus voluptatem deleniti animi, eum dicta quidem.</p>
