    ...
    <section className='section'>
        <div className="container grid md:grid-cols-2 md:items-center gap-[50px]">
            ...
            <div className="md:order-1">
                ...
                <p className="mb-8">At Homely, we connect people with homes they love. With over 10 years of industry experience, we provide expert guidance for buyers, sellers, and investors across multiple cities.</p>

                {/* Stats */}
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-5 md:gap-10 text-center" ref={ref}>
                    {stats.map((stat)=>(
                        <div key={stat.id}>
