        ...
        <div className="container">
            ...
            <div className="grid gap-7 sm:grid-cols-2 md:grid-cols-[1fr_0.5fr_1fr_1fr]">
                ...
                <div>
                    ...
                    <p className="my-[14px] text-neutral-50/60">Helping you find the perfect home with expert guidance and a seamless experience.</p>

                    <div className="flex mt-3 gap-6">
                        {footerSocialIcons.map((icon,index) => (
                            <a href="#" key={index} className="hover:text-sky-500 transition-colors">{icon.icon}</a>
                        ))}
                    </div>
                </div>
